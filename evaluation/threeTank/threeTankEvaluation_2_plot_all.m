...
normData_x = [mean_data_ds(3:end);mean_data_ds(3:end)];
normData_u = [mean_data_ds(1:2);mean_data_ds(1:2)];
...
A = double(subs(jacobian(f,[x1 x2 x3]),[x1 x2 x3],normData_x(1,:)));
eig_ref = eig(expm(A*5));

% TODO insert path of the evaluation data
