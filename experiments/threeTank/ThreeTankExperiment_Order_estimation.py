...
params['initialize_lin_model_random'] = True
...
path_to_data = 'data/threeTank/threeTank'
...
params['system_outputs'] = [0, 1, 2]  # set outputs that are measured

# TODO insert number of inpus
params['dim_system_input'] = 2
...
params['alpha_state_prediction_loss'] = 0.8
...
params['alpha_input_prediction_loss'] = 0.7
...
looper_params = [
                 ...
                 ['models/S4_n_4/', 1, 4, [w_state, 20, 40, 60, 4],
                  [4, 20, 40, 60, w_state], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['models/S1_n_4/', 2, 4, [w_state, 20, 40, 60, 4 - 3],
                  [3], [params['dim_system_input']], [params['dim_system_input']]],
                 ['models/S2_n_4/', 2, 4, [w_state, 20, 40, 60, 4 - 3],
                  [3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['models/S3_n_5/', 1, 5, [w_state, 20, 40, 60, 5],
                  [5, 20, 40, 60, w_state], [params['dim_system_input']], [params['dim_system_input']]],
                 ['models/S4_n_5/', 1, 5, [w_state, 20, 40, 60, 5],
                  [5, 20, 40, 60, w_state], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['models/S1_n_5/', 2, 5, [w_state, 20, 40, 60, 5 - 3],
                  [3], [params['dim_system_input']], [params['dim_system_input']]],
                 ['models/S2_n_5/', 2, 5, [w_state, 20, 40, 60, 5 - 3],
                  [3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['models/S3_n_6/', 1, 6, [w_state, 20, 40, 80, 6],
                  [6, 20, 40, 80, w_state], [params['dim_system_input']], [params['dim_system_input']]],
                 ['models/S4_n_6/', 1, 6, [w_state, 20, 40, 80, 6],
                  [6, 20, 40, 80, w_state], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['models/S1_n_6/', 2, 6, [w_state, 20, 40, 80, 6 - 3],
                  [3], [params['dim_system_input']], [params['dim_system_input']]],
                 ['models/S2_n_6/', 2, 6, [w_state, 20, 40, 80, 6 - 3],
                  [3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['models/S3_n_7/', 1, 7, [w_state, 20, 40, 80, 7],
                  [7, 20, 40, 80, w_state], [params['dim_system_input']], [params['dim_system_input']]],
                 ['models/S4_n_7/', 1, 7, [w_state, 20, 40, 80, 7],
                  [7, 20, 40, 80, w_state], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['models/S1_n_7/', 2, 7, [w_state, 20, 40, 80, 7 - 3],
                  [3], [params['dim_system_input']], [params['dim_system_input']]],
                 ['models/S2_n_7/', 2, 7, [w_state, 20, 40, 80, 7 - 3],
                  [3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['models/S3_n_8/', 1, 8, [w_state, 20, 40, 80, 8],
                  [8, 20, 40, 80, w_state], [params['dim_system_input']], [params['dim_system_input']]],
                 ['models/S4_n_8/', 1, 8, [w_state, 20, 40, 80, 8],
                  [8, 20, 40, 80, w_state], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['models/S1_n_8/', 2, 8, [w_state, 20, 40, 80, 8 - 3],
                  [3], [params['dim_system_input']], [params['dim_system_input']]],
                 ['models/S2_n_8/', 2, 8, [w_state, 20, 40, 80, 8 - 3],
                  [3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['models/S3_n_9/', 1, 9, [w_state, 20, 40, 100, 9],
                  [9, 20, 40, 100, w_state], [params['dim_system_input']], [params['dim_system_input']]],
                 ['models/S4_n_9/', 1, 9, [w_state, 20, 40, 100, 9],
                  [9, 20, 40, 100, w_state], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['models/S1_n_9/', 2, 9, [w_state, 20, 40, 100, 9 - 3],
                  [3], [params['dim_system_input']], [params['dim_system_input']]],
                 ['models/S2_n_9/', 2, 9, [w_state, 20, 40, 100, 9 - 3],
                  [3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['models/S3_n_10/', 1, 10, [w_state, 20, 40, 100, 10],
                  [10, 20, 40, 100, w_state], [params['dim_system_input']], [params['dim_system_input']]],
                 ['models/S4_n_10/', 1, 10, [w_state, 20, 40, 100, 10],
                  [10, 20, 40, 100, w_state], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['models/S1_n_10/', 2, 10, [w_state, 20, 40, 100, 10 - 3],
                  [3], [params['dim_system_input']], [params['dim_system_input']]],
                 ['models/S2_n_10/', 2, 10, [w_state, 20, 40, 100, 10 - 3],
                  [3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['models/S3_n_20/', 1, 20, [w_state, 20, 60, 120, 20],
                  [20, 20, 60, 120, w_state], [params['dim_system_input']], [params['dim_system_input']]],
                 ['models/S4_n_20/', 1, 20, [w_state, 20, 60, 120, 20],
                  [20, 20, 60, 120, w_state], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]],
                 ['models/S1_n_20/', 2, 20, [w_state, 20, 60, 120, 20 - 3],
                  [3], [params['dim_system_input']], [params['dim_system_input']]],
                 ['models/S2_n_20/', 2, 20, [w_state, 20, 60, 120, 20 - 3],
                  [3], [w_input, 10, 20, w_input], [w_input, 10, 20, w_input]]
                 ]
